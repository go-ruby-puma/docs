...
The public API lives at the module root (`github.com/go-ruby-puma/puma`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `puma`, while the surface follows
...
```go
import "github.com/go-ruby-puma/puma"
```
...
- **[pkg.go.dev/github.com/go-ruby-puma/puma](https://pkg.go.dev/github.com/go-ruby-puma/puma)**

The module's [README](https://github.com/go-ruby-puma/puma#readme) carries worked
